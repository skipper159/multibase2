...
import { Database, Plus, Download, Trash2, RotateCcw, ArrowLeft, HardDrive, Server } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Create and manage backups of your instances
              </p>
            </div>
            <button
                ...
                backups.map((backup) => (
                  <tr key={backup.id} className="hover:bg-muted/50">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium border ${getTypeColor(backup.type)}`}>
